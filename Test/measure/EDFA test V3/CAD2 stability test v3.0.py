...
startTime = time.time()
logPath = ".\\results\\{0}_{1}_{2}_{3}".format("45C_Stability_EDFA2",Vendor,SN,curTime)
os.mkdir(logPath)
...
Po=-2 
Pout_cmd="hw 1 ofp2 2 c x SetPowerSetting EDFA_2 " + str(Po*100) #mdBm
hal.write(Pout_cmd)
