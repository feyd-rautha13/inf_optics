...
startTime = time.time()
logPath = ".\\results\\{0}_{1}_{2}_{3}".format("45C_Steady_EDFA1",Vendor,SN,curTime)
os.mkdir(logPath)
...
Pin=[-14, 7, -18, 3, -22, -1, -28, -7]
Gain=[10, 10, 14, 14, 18, 18, 24, 24]
NFspec=[14.2, 14.2, 9.1, 9.1, 6.3, 6.3, 5.1, 5]
