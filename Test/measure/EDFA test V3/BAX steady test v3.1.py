...
__version__ = "3.1" 
# reconfig and cal for Tcase test
...
startTime = time.time()
logPath = ".\\results\\{0}_{1}_{2}_{3}".format("25C_Steady_BAX",Vendor,SN,curTime)
...
NFspec=[9.6, 9.6, 7.3, 7.3, 6.1, 6.1, 5.5, 5.5, 5.2, 5.2]

#hal.write("hw 1 ofp2 2 c x SetTilt EDFA_2 " + str(-3*100))
